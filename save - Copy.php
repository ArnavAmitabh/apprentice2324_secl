...
else
{
   ...
   if ($conn->query($query2) == TRUE) {
	   echo "<br><br><br><br><br><br><br><br><h2 style ='text-align: center;font-size: 30px;color:green;'>User successfully Registered! Your Registration number is ".$row1['regno']  . "</h2>";    
